...
A ideia que se teve com essa aplicação, foi a de usar o texto da descrição das vagas para a predição do salário das mesmas, o algoritmo usado para a vetorização do texto foi o Word2Vec, que consiste em uma incorporação de palavras a partir de um chamado corpus de texto.
